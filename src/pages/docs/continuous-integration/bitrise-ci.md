...
1. Once a user logs in, user has to create a workspace. A workspace can be created either byusing the plus icon on the screen or under the profile picture of the user.
   ...
   ![Create Work space Step 1](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-create-workplace-1.png)

   ![Create Work space Step 2](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-create-workplace-step-2.png)

2. Mention the name of the workspace you would like to create:
   ![Fill workspace name](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-workplace-form.png)



### Part2: Add an app by selecting the Account / Workspace.
1. Once the workspace is created, proceed to add the app:
   ![Add new app](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-add-app.png)
...
3. Set the privacy for the app as per your requirement:
   ![Choose account](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-set-app-privacy.png) 
...
5. You would be prompted to choose a repository for the workspace from a list of options. You can even setup a path manually by selecting the manual setup option:
   ![Choose repo](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-github-repo-connect.png)
   ![Connect repo](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-github-repo.png)
6. In case the repository is not a public repository, please update the link for repository accordingly:
   ![Connect repo](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-github-private-confirm.png)
7. Choose a branch for the build
   ![Select Branch](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-github-branch-selection.png)
...
9. If the system is unable to verify the repository, you can update the URL or even proceed to configure the same manually
   ![Manual Configure](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-automatic-configuration-failed.png)
10. Click on Proceed to move to the next step.
11. Select an appropriate option from the project build configuration list
    ![Select App Type](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-select-application-type.png)
12. Click ‘I m ready’ and then click on Finish and will see bellow screen if everything is proper
    ![Successfully added App](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-create-app.png)

### Part3: Configure the shell script as Step

1. Select the App and move to the Workflow Editor.
   ![Workflow builder](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-select-app.png)
...
4. Inorder to delete any steps, select the step by clicking on it and scroll down until the Delete Step button is visible.
   ![Workflow builder - delete step](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-delete-step.png)
5. Click ‘Delete Step’ button to delete the steps.
6. Click on the + icon to add a new step
   ![Workflow add shell](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-add-shell-script.png)
7. Search for the task that you want to add as part of the step.
   ![Workflow step runner](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-add-script-runner.png)
...
9. In this case to execute the Test Plan developed in Testsigma, you have to update the filename / filepath of the shell script file
   ...
   - MAX_WAIT_TIME_FOR_SCRIPT_TO_EXIT <br/>
     ![Workflow step inputs](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-step-inputs.png)
...
11. Once all steps are updated, click on the save button to save the build pipeline.
    ![Workflow Save](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-save-workflow.png)
12. Once the build pipeline is saved successfully, you can trigger the build run or even schedule the run.
    ![Schedule Build](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-schedule-build.png)
13. Select appropriate details and click ‘Start Build’ button.
    ![Workflow form](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/bitrise-build-form.png)

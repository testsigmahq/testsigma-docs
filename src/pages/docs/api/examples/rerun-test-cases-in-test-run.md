...
|**Request Type**|**GET**|
|---|---|
|**Endpoint**|<a href="https://app.testsigma.com/api/v1/execution_results/986/test_case_results" rel="nofollow">https://app.testsigma.com/api/v1/execution_results/986/test_case_results</a>| 

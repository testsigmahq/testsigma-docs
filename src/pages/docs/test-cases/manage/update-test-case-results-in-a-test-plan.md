...
1. From the left-side navbar, go to **Test Plans**.
   ...
   ![Test Plans](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_plans/update_test_case_report_1.png)


2. Select the test plan in which you want to update the test case result and click **View Reports**.

   ![View Reports](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_plans/update_test_case_report_2.png)
...
3. Hover over the test case result of which you want to change the status and click on the result you want to update from the dropdown menu.
   ...
   ![Result Dropdown](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_plans/update_test_case_report_3.png)


4. On the **Add Comments** dialog, add a comment and click on **Save**.

   ![Add Comments](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_plans/update_test_case_report_4.png)

5. Hover over the same test case result to see the updated status and comment.

   ![Updated Status](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_plans/update_test_case_report_5.png)

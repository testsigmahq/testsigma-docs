...
![Navigate to uploads](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/navigate_uploads.png)
2. Hover over the upload you want to update.
    - Click on **Edit**.
    ![Click on edit](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/hover_uploads_edit.png)
    - Click on **Choose file** to upload the new version of the APK.
    ![Click On choose file](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/choose_apk.png)
    - Enter the **Name** , **Version** and click on **Update**.
    ![Click On update](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/rename_version.png)
...
Create a test case and use Install the app name and app-version NLP to test your new version.
    ...
    ![Hover App-name](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/NLP_appname.png)
    - Hover over the **app-version** to select the version from the dropdown menu.
    ![Hover app-version](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/NLP_appversion.png)

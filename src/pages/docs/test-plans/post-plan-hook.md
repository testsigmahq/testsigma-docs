...
> 2. [Documentation on managing add-ons](https://testsigma.com/docs/addons/classic/create/).
> 3. [Documentation on creating add-on](https://testsigma.com/docs/addons/classic/create-a-post-plan-hook-add-on/). 

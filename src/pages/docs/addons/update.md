...
> 1. You have referred to the [documentation on creating addons](https://testsigma.com/docs/addons/create/#creating-an-addon-template).
...
2. From the left navigation bar, go to **Addons** and click **Addons** from the dropdown. 

...
>    - Account URL.
>    - API Key (For more information, refer to <a href="https://zepel.io/developers/api/v1/#authentication" rel="nofollow">creating your Zepel API token</a>).
> 2. You have referred to the <a href="https://testsigma.com/docs/runs/test-plan-executions/" rel="nofollow">documentation on creating test plan runs and results</a>.

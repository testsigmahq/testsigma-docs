...
metadesc: "Learn how Copilot streamlines test authoring, debugging, and execution with capabilities designed to improve efficiency."
noindex: false
order: 11.12
page_id: "key-capabilities"
search_keyword: ""
warning: false
...
|---|---|---|
| Cloud or Local Execution | Runs a Copilot session on the **Testsigma Cloud Lab** or on your **Local Devices** through the **Testsigma Terminal**. | Lets you start a session without any local setup, or use local devices when your application isn't reachable from the cloud. |

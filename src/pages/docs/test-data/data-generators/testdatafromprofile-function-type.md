...
![NLP](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_tdp_1.png)

3. Click on the **test data** placeholder. From the **Test Data Types** dropdown menu, select the **! Data Generator** option.
![Test Data Types](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_tdp_2.png)
...
![Data Gen](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_tdp_3.png)

5. Select **TestDataFromProfile** from the **Function Type** dropdown list. 
![select testdatafromprofile function type from data generators](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_tdp_4.png)

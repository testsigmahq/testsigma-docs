...
![NLP](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_namefunction_2.png)

3. Click on the **test data** placeholder. From the **Test Data Types** dropdown menu, select the **! Data Generator** option.
![Test Data type](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_namefunction_3.png)
...
![Default](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_namefunction_4.png)

5. Select **NameFunctions** from the **Function Type** dropdown list. 
![select namefunctions function type from data generators](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_namefunction_5.png)

...
4. Select **Phone Number** from the **Function Type** dropdown list. ![select phone number function type from data generators](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/phonenumber_functiontype_dg.gif)

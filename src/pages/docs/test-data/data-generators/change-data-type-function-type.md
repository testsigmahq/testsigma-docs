...
![New Steps](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_change_1.png)

3. Click on the **test data** placeholder. From the **Test Data Types** dropdown menu, select the **! Data Generator** option.
![Test data type](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_change_2.png)
...
![Default](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_change_3.png)

5. Select **ChangeDataType** from the **Function Type** dropdown list. 
![select changedatatype function type from data generators](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/test_data/update_change_4.png)

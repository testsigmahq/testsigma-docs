...
4. Select **Address** from the **Function Type** dropdown list. ![select address function type from data generators](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/address_functiontype_dg.gif)

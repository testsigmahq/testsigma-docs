...
![NLP](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/salesforce/update_data_types_1.png)
1. Replace the **test data** placeholder by clicking on it, and the **Test Data Types** drop-down menu will appear, as shown below.
   ...
   - **Phone Number**
   - **Mailbox**
   ![Select Test Data Types](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/salesforce/update_data_types_2.png)
...
![Plain Text data type](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/salesforce/update_data_types_3.png)
...
| <br>
|
| Here’s a screenshot showing how to use a blank value as test data.
|
| ![Blank Value](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/salesforce/update_data_types_4.png)
...
- To use Parameter Test Data, use the **@ Parameter** type and replace the word "**Parameter**" with the specified parameter name. For example, replace test data with **@ user 1**, where **user 1** corresponds to the parameter name in the **Test Data Profile**. ![Parameter Testdata Type](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/salesforce/update_data_types_5.png)

...
3. For Test Machine, Test Suite, or Test Case level reports:
   ...
   - Unhide the **Content** and copy the required **ID**. ![retrieving result ids](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/update_custompdf_2.png)

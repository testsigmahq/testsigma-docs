...
> 4. An **HTML template** for the PDF report.  <a href="https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/Custom_Report_Template.txt" rel="nofollow">Click here</a> to download the HTML template.
...
2. For **test plan** level reports, Use the Run ID directly from the Run Result page. You can find this in the Execution ID or the URL endpoint. Copy the Run ID from the Run Result page. ![retrieving runid for test plan level](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/testplan_run_id.cpr.gif)
3. For Test Machine, Test Suite, or Test Case level reports:
   ...
   - Unhide the **Content** and copy the required **ID**. ![retrieving result ids](https://s3.amazonaws.com/website-static-docs.testsigma.com/new_images/projects/Updated_Doc_Images/case-machine-suitelevel-id-cpr.gif)

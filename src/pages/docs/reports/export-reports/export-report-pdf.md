...
![Run Result](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/exports/update_test_result_1.png)
2. Open the specific **Test Run** from the **Run Result** list page to export the test report file.
![Run Result](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/exports/update_test_result_2.png)
3. Click the **Export** icon, and a dropdown list will appear.
![Export](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/exports/update_test_result_3.png)
4. Select **PDF** from the dropdown list to initiate the export of the Test Plan results. 
![PDF](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/exports/update_test_result_4.png)
5. In the **Export PDF** dialog box, select one of the following options under **Test step screenshots** and **Test step screenshots**, and click **Export**:
     ...
     - **All Screenshots**
     - **No Screenshots** 
     ![Export](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/exports/update_test_result_5.png)
[[info | **NOTE**:]]
...
7. Click on the file named **(Test Plan Name with build run YYYYMMDD).pdf** to access the exported results. ![notify pdf report in email](https://s3.amazonaws.com/static-docs.testsigma.com/new_images/projects/applications/notify_pdf_exportrepot.png)

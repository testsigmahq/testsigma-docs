                ...
                <div className="w-full">
                    <div className="flex items-stretch">
                        <div className="w-1/4 max-w-sm justify-center flex">
                            <button
                                className="w-2/5 my-5 rounded-l-2xl border-green-600 bg-green-600 text-white bg-transparent border-l border-t border-b font-bold text-xs px-4 py-2 rounded-l outline-none focus:outline-none ease-linear transition-all duration-150"
                                type="button">
                                Community Edition
                            </button>
                            <button
                                className="w-2/5 my-5 rounded-r-2xl border-green-600 bg-transparent border border-solid font-bold text-xs px-4 py-2 outline-none focus:outline-none ease-linear transition-all duration-150"
                                type="button">
                                Testsigma Cloud
                            </button>
                        </div>
                        <div className="flex-auto flex  items-center">
                            <div className="flex w-4/5 border-r">
                                <button className="flex ml-20 my-2 bg-green-600 bg-transparent border-green-600 duration-150 ease-linear focus:outline-none font-bold h-1/2 outline-none px-4 py-2 rounded-3xl text-white text-xs transition-all">
                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="pr-1.5">
                                        <path d="M1.79486 2.68311H2.99125V3.8795H1.79486V2.68311Z" fill="white"/>
                                        <path d="M4.18744 2.68311H5.38383V3.8795H4.18744V2.68311Z" fill="white"/>
                                        <path d="M6.58008 2.68311H7.77647V3.8795H6.58008V2.68311Z" fill="white"/>
                                        <path d="M14.0625 0.888672H0.9375C0.68886 0.888672 0.450403 0.987444 0.274587 1.16326C0.098772 1.33907 0 1.57753 0 1.82617V13.0762C0 13.3248 0.098772 13.5633 0.274587 13.7391C0.450403 13.9149 0.68886 14.0137 0.9375 14.0137H14.0625C14.3111 14.0137 14.5496 13.9149 14.7254 13.7391C14.9012 13.5633 15 13.3248 15 13.0762V1.82617C15 1.57753 14.9012 1.33907 14.7254 1.16326C14.5496 0.987444 14.3111 0.888672 14.0625 0.888672ZM0.9375 1.82617H14.0625V3.79492H0.9375V1.82617ZM0.9375 13.0762V4.54492H14.0625V13.0762H0.9375Z" fill="white"/>
                                    </svg>
                                    Web
                                </button>
